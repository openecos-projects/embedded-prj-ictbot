...
//   va_list va;
//   va_start(va, format);
//   const int ret = _vsnprintf(_out_buffer, str, (size_t)-1, format, va);
//   va_end(va);
//   return ret;
// }
...
//   va_list va;
//   va_start(va, format);
//   const int ret = _vsnprintf(_out_buffer, str, size, format, va);
//   va_end(va);
//   return ret;
// }
...
// {
//   return _vsnprintf(_out_char, str, (size_t)-1, format, ap);
// }


// int vsnprintf(char* str, size_t size, const char* format, va_list ap)
// {
//   return _vsnprintf(_out_buffer, str, size, format, ap);
// }
